...
Hardware 2v0 (mit DFPlayer-BUSY-Signal, GPIO34), Firmware 20v14,
Konfiguration SysConf_20v14.h
...
- **DFRobotDFPlayerMini**: DFPlayer Mini Steuerung über Serial2.
  Unveränderte Originalversion – der in 12v13 versuchte Patch in `available()`
  wurde in 12v14 zurückgenommen, siehe `Software/Bibliotheken/README.md`.
...
└── Software/
    ├── Bibliotheken/
    ├── Firmware_aktuell/          ← Wecker_20v14.ino, SysConf_20v14.h, WEB.h
    └── Firmware_Versionshistorie/ ← ältere Stände (12vNN, 13v00, 20v00–20v12)
```
