...
// ── Konfiguration ────────────────────────────────────────────
#include "SysConf_20v21.h"                                                               // Pin-Belegung, Timing-Konstanten, Touch-Schwellwerte
#include "WEB.h"
...
static UiState onAlarm1(uint8_t evt) {
  switch (evt) {
    ...
    case EVT_T3:                                                                         // Stunde +
      ...
      lastA1Day = 0xFFFF;                                                                 // Tages-Sperre bei Zeitänderung aufheben, sonst blockt alarmDue() die neue Zeit noch am selben Tag
    ...
    case EVT_T4:                                                                         // Minute +
      ...
      lastA1Day = 0xFFFF;                                                                 // siehe EVT_T3 oben
      snprintf(str_a1, sizeof(str_a1), "%02u:%02u", a1_hour, a1_min);
      cleanTXT(82, 34, 46, 13);
      zeigeZ16C(105, 32, str_a1);
      display.display();                                                                 // partielles Update übertragen
...
static UiState onAlarm2(uint8_t evt) {
  switch (evt) {
    ...
    case EVT_T3:                                                                         // Stunde +
      ...
      lastA2Day = 0xFFFF;                                                                 // Tages-Sperre bei Zeitänderung aufheben, sonst blockt alarmDue() die neue Zeit noch am selben Tag
    ...
    case EVT_T4:                                                                         // Minute +
      ...
      lastA2Day = 0xFFFF;                                                                 // siehe EVT_T3 oben
      snprintf(str_a2, sizeof(str_a2), "%02u:%02u", a2_hour, a2_min);
...
void setup() {
  ...
  const esp_task_wdt_config_t twdt_cfg = {
    .timeout_ms    = WDT_HARDWARE_MS,  // aus SysConf_20v21.h
